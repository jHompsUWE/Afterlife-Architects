...
OldEventManager& OldEventManager::Get()
{
    static OldEventManager instance;
    return instance;
}
 ...
 */
void OldEventManager::GenerateEvent(AfterlifeEvent _event)
{
 ...
 */
void OldEventManager::ReadInput(GameData* game_data)
{
 ...
 */
std::list<AfterlifeEvent>& OldEventManager::GetEventList()
{
...
void OldEventManager::IGenerateEvent(AfterlifeEvent _event)
{
 ...
 */
void OldEventManager::IReadInput(GameData* game_data)
{
 ...
 */
void OldEventManager::MapInputToEvent(const bool& pressed, AfterlifeEvent event)
{
    if(pressed)
    {
