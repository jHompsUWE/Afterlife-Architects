...
StructureGate::StructureGate(ID3D11Device* GD, Vector2 width_height, Vector3 tile_pos, int _tile_size, std::string texture, PlaneType _plane, float _soul_rate, EconomyManager* _econ_manager) :
